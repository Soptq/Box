...
public class ShellInputActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.shellinput);
  ...
  final class RunCommandTask extends AsyncTask<String, Void, CommandResult> {
    ...
    @Override protected void onPreExecute() {
      dialog = ProgressDialog.show(ShellInputActivity.this, "Running Command", "Please Wait...");
